...
import {
  BasicTransportType, DeviceEthernetItems, deviceEthernetItemsTranslateMap,
  DeviceEthernetType,
  deviceEthernetTypeTranslateMap,
  DeviceTransportType,
...
import {DeviceCheckConnectivityDialogData} from "@home/pages/device/device-check-connectivity-dialog.component";

@Component({
  selector: 'tb-set-ethernet-dialog',
  templateUrl: './set-ethernet-dialog.component.html',
  styleUrls: ['./set-ethernet-dialog.component.scss']
})
export class SetEthernetDialogComponent extends
  DialogComponent<SetEthernetDialogComponent> implements OnInit, OnDestroy{
  ...
  configItems = [...Object.keys(DeviceEthernetType)] as Array<DeviceEthernetType>;
  ethernetItems = [...Object.keys(DeviceEthernetItems)] as Array<DeviceEthernetItems>;
  DeviceTransportType = DeviceTransportType;
  selectedEthernetType: DeviceEthernetType = DeviceEthernetType.DEFAULT;
  ...
  constructor(protected store: Store<AppState>,
              ...
              public dialogRef: MatDialogRef<SetEthernetDialogComponent>,
              private deviceService: DeviceService,
              private telemetryWsService: TelemetryWebsocketService,
              private zone: NgZone) {
    super(store, router, dialogRef);
    this.dialogTitle = 'device.ethernet.settings';
  ...
  protected readonly DeviceEthernetType = DeviceEthernetType;
  protected readonly deviceEthernetTypeTranslateMap = deviceEthernetTypeTranslateMap;
  protected readonly deviceEthernetItemsTranslateMap = deviceEthernetItemsTranslateMap;

  selectEthernetType(type: DeviceEthernetType) {
    this.selectedEthernetType = type;
  }
